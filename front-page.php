            ...
            <div class="about__box row justify-content-between">
                ...
                <div class="col-lg-7 col-12 section__right">
                    <figure class="about__image">
                        <img src="<?php echo get_field('about_image_en')['url']; ?>"
                            alt="<?php echo get_field('about_image_en')['alt']; ?>">
                    </figure>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="section__box row justify-content-between">
                <div class="col-lg-5 col-12 section__left section__left_more">
                    <div class="section-more__text col-xxl-10 col-lg-11 col-12">
...
-->
    ...
    <section id="services_en" class="services">
        <div class="container">
            <h2 class="services__heading">
            ...
            <ul class="row services-box services__list cols-lg-3 cols-md-2 cols-1">
                <li class="services-box__item col-auto">
                    ...
                    <p class="services-box__text js-slideTo">
    ...
    <section id="appart" class="appart">
        ...
        if ($mypost_Query2->have_posts()) {
            while ($mypost_Query2->have_posts()) {
                ...
                ?>
                <article id="article1" class="article-one appart__article appart__article_first col-xl-10 col-12 row"
                    ...
                    <div class="article__container">
                        ...
                        <div class="article-one__headings d-flex flex-column flex-sm-row align-items-start align-items-sm-center">
                            <h2 class="article-one__heading">
                                <?php the_title(); ?>
                            </h2>
                            <p class="article-one__subheading mobile">
                        ...
                        ?>
                        <p class="article-one__subheading desctop">
                            Room size <?php the_field('number_size_en'); ?> sq. m .
                        </p>

                        <div class="row article-list article-one__list" data-simplebar>
                            <div class="article-list__list col-sm-11 col-lg-12 col-12">
                        ...
                        <div class="row article-one__descr align-items-center col-md-10 col-12 justify-content-between">
                            ...
                            <?php
                            if (get_field('price_en')) { ?>
                                <p class="col-auto article-one__price"><?= the_field('price_en'); ?> rub</p>
                            <?php }
                            if (get_field('price_old_en')) { ?>
                                <p class="col-auto appart-box__old"><s><?= the_field('price_old_en'); ?> rub</s></p>
                            <?php } ?>
                        </div>

                        <div class="row article-one__btn">
                            <a class="gold-button col-sm-4 col-8" href="/en/booking-en/">to book</a>
                        </div>
                    </div>
                </article>
            <?php }
        } ?>
        <!-- Скрываем блок уютных номеров для ENG
        <div class="container">
                    ...
                    while ($mypost_Query->have_posts()) {
                        ...
                        <li class="appart-box__item col-auto">
                            ...
                            <div class="row appart-box__descr align-items-center">
                                ...
                                <?php
                                if (get_field('price_en')) { ?>
                                    <p class="col-5 appart-box__price"><?= the_field('price_en'); ?> rub</p>
                                <?php }
                                if (get_field('price_old_en')) { ?>
                                    <p class="col-4 appart-box__old"><s><?= the_field('price_old_en'); ?> rub</s></p>
                                <?php } ?>
                            </div>

                            <div class="row appart-box__buttons">
                                <a class="gold-button appart-box__button col-6" href="/en/booking-en/">to book</a>
                                <?php
                                global $post;
                                $id = get_the_ID();
                                ?>
                ...
                <div class="container">
                    <div class="row villa__contain">
                        <div class="villa__left col-lg-6 col-12">
                            ...
                            <a class="gold-button villa__button col-7" href="/en/booking-en/">to book</a>
                        </div>
            ...
            <div class="container">
                <div class="row spa-box spa__box">
                    <div class="spa-box__left col-lg-6 col-12">
                        ...
                        $spa_small_img_3_en = get_field('spa_small_img_3_en');
                        if ($spa_small_img_1_en && $spa_small_img_2_en && $spa_small_img_3_en) { ?>

                            <div class="spa-box__images row col-12 justify-content-between">
                                ...
                                <figure class="villa-cards__image villa-cards__image_spa col-auto">
                                    <img src="<?php echo $spa_small_img_3_en['url']; ?>" alt="<?php echo $spa_small_img_3_en['alt']; ?>" class="swiper-apart__img">
                                </figure>
                            </div>
-->
                            <? } ?>
            ...
            <div class="pool__cont d-flex align-items-start justify-content-between">
                <div class="row pool-box pool__box">
                    ...
                    <div class="row pool-box__button">
                        <a class="gold-button villa__button col-6" href="/en/booking-en/">to book</a>
                    </div>
                </div>
                        ...
                        <div class="spa-box__right spa-box__right_transfer col-lg-6 col-12">
                            <div class="spa-box__descr col-xl-10 col-12 justify-self-end">
                                ...
                                <div class="col-12 transfer__image">
                                    <img src="<?php the_field('transfer_img'); ?>" alt="Трансфер от Vertex"
                                        class="transfer__img">
                                </div>
                ...
                <row class="contact__box row align-items-stretch justify-content-between">
                    ...
                    <div class="contact__image col-lg-7 col-12"
                        ...
                        <div class="contact__block col-sm-9 col-11 position-relative">
                            ...
                            <a class="gold-button col-xl-6 col-sm-7 col-12" href="/en/booking-en/">book a room</a>
                        </div>
                    </div>
                </row>
            </div>
                ...
                <article id="article1" class="article-one appart__article appart__article_first col-xl-10 col-12 row"
                    ...
                    <div class="article__container">
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <?php if (have_rows('галерея_номера', $id)): ?>
                                    <?php while (have_rows('галерея_номера', $id)):
                                        ...
                                        ?>
                                        <div class="swiper-slide swiper-appart__slide">
                                            <a class="swiper-appart__image" href="<?= $images; ?>" data-fancybox="appart">
                        ...
                        <div class="row article-one__descr align-items-center col-md-10 col-12 justify-content-between">
                            ...
                            <?php
                            if (get_field('price')) { ?>
                                <p class="col-auto article-one__price"><?= the_field('price'); ?> р</p>
                            <?php }
                            if (get_field('price_old')) { ?>
                                <p class="col-auto appart-box__old"><s><?= the_field('price_old'); ?> р</s></p>
                            <?php } ?>
                        </div>
                    ...
                    while ($mypost_Query->have_posts()) {
                        ...
                        <li class="appart-box__item col-auto">
                            ...
                            <div class="row appart-box__descr align-items-center">
                                ...
                                <?php
                                if (get_field('price')) { ?>
                                    <p class="col-5 appart-box__price"><?= the_field('price'); ?> р</p>
                                <?php }
                                if (get_field('price_old')) { ?>
                                    <p class="col-4 appart-box__old"><s><?= the_field('price_old'); ?> р</s></p>
                                <?php } ?>
                            </div>
            ...
            <div class="container">
                <div class="row spa-box spa__box">
                    <div class="spa-box__left col-lg-6 col-12">
                        ...
                        $spa_small_img_3 = get_field('spa_small_img_3');
                        if ($spa_small_img_1 && $spa_small_img_2 && $spa_small_img_3) { ?>
                            ...
                            <div class="spa-box__images row col-12 justify-content-between">
                                ...
                                <figure class="villa-cards__image villa-cards__image_spa col-auto">
                                    <img src="<?php echo $spa_small_img_3['url']; ?>" alt="<?php echo $spa_small_img_3['alt']; ?>" class="swiper-apart__img">
                                </figure>
                            </div>
-->
                            <? } ?>
