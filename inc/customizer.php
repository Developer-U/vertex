	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		...
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => 'vertex_customize_partial_blogdescription',
			)
		);
	}
}
 ...
 * @return void
 */
function vertex_customize_partial_blogdescription() {
...
function vertex_customize_preview_js() {
	wp_enqueue_script( 'vertex-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), _S_VERSION, true );
}
